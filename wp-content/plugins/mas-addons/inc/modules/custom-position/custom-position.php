...
class Mas_Addons_Positioning {
    ...
    public function __construct() {
        ...
        add_action("elementor/element/after_section_end", array($this, 'mas_addons_add_position_controls_section'), 10, 3);

    }

    public function mas_addons_add_position_controls_section($widget, $section_id, $args) {
        ...
        $widget->start_controls_section(
            ...
            'mas_addons_section_advanced_position',

            array(

                'label' => MAS_ADDONS_BADGE . __('Positioning', 'mas-addons'),
        ...
        $widget->add_responsive_control(
            ...
            array(
                ...
                'condition'  => array(
                    ...
                    'mas_addons_position_type' => array('relative', 'absolute'),
        ...
        $widget->add_responsive_control(
            ...
            'mas_addons_position_from_center',
...
Mas_Addons_Positioning::get_instance();